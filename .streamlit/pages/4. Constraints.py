...
st.image('.streamlit/streamlit_images/Screenshot 2023-04-11 at 17.12.19.png')
...
with col2:
    st.title("")
    st.title("")
    st.image(".streamlit/streamlit_images/Screenshot 2023-04-11 at 21.13.52.png")
...
st.image(".streamlit/streamlit_images/Screenshot 2023-04-11 at 22.37.36.png")
